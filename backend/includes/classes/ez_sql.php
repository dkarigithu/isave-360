...
/*
	define("EZSQL_DB_USER", "a7066791_isave");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "kawess2k");		// <-- mysql db password
	define("EZSQL_DB_NAME", "a7066791_alice");		// <-- mysql db pname
	define("EZSQL_DB_HOST", "mysql5.000webhost.com");	// <-- mysql server host
*/

//this is for when testing in localhost
	define("EZSQL_DB_USER", "luckymsc");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "tfCunGDmAb4QUC5B");		// <-- mysql db password
	define("EZSQL_DB_NAME", "alice");		// <-- mysql db pname
